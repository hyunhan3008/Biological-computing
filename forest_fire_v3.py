...
def transition_func(grid, neighbourstates, neighbourcounts, decaygrid, randomgrid, terraingrid, probabilitygrid, windgrid, delaygrid):
    ...
    wind_direction2 = (SE > 3)
    windgrid[wind_direction2] += 0.6
    
    wind_direction3 = (SW > 3)
    windgrid[wind_direction3] += 0.6
    
    wind_direction4 = (NE > 3)
    windgrid[wind_direction4] += 0.4
    
    wind_direction5 = (NW > 3)
    windgrid[wind_direction5] += 0.4
    
    opposite_direction6 = (N > 3)
    windgrid[opposite_direction6] -= 2.4

    opposite_direction6 = (E > 3)
    windgrid[opposite_direction6] -= 0.25
    ...
    opposite_direction7 = (W > 3)
    windgrid[opposite_direction7] -= 0.25
 
    opposite_direction8 = (E > 3)
    windgrid[opposite_direction8] -= 0.25
...
"hello"
    ...
    ignited_chap = (((decaygrid == 0) & (random_and_wind > 0.35) & at_least_1_neighbour & ignitable_terrain & (delay_and_wind > 0.35))) | ((decaygrid == 0) & (random_and_delay >= 7) & ignitable_terrain) | has_three_neighbours & ignitable_terrain
